    ...
    <div className="bg-gray-50 pt-10 sm:pt-14">
      <div className="max-w-[90%] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-[36px] font-bold text-gray-900 sm:text-4xl">
            {heading}
          </h2>
          <p className="mt-3 text-[20px] font-normal font-sans text-gray-500 sm:mt-4">{description}</p>
        </div>
      </div>
            ...
            <div className="max-w-4xl mx-auto">
              <dl className="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
                <div className="flex flex-col border-b border-gray-100 p-7 text-center sm:border-0 sm:border-r">
                  <dt className="order-2 mt-1 font-sans text-[18px] leading-6 font-medium text-gray-500">
                    {nameLeft}
                  </dt>
                  <dd className="order-1 mb-3 font-sans text-[48px] font-bold text-emerald-400">
                    {statsLeft}
                  </dd>
                </div>
