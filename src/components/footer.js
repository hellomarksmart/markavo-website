...
const Footer = () => {
  return (
    <footer className="bg-emerald-400" aria-labelledby="footer-heading">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <ul role="list" className="mt-4 space-y-4 ml-0">
                  {navigation.registrations.map(item => (
                    <li key={item.name}>
                      <Link
                        to={item.href}
                        className="text-sm text-white hover:slate-200"
                      >
                        {item.name}
                      </Link>
                    </li>
        ...
        <div className="border-t border-white pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
          <div>
            <h3 className="text-sm font-semibold text-white tracking-wider uppercase">
              Newsletter
            </h3>
          ...
          <form className="mt-4 sm:flex sm:max-w-md lg:mt-0">
            <input
              ...
              autoComplete="email"
              required
              className="appearance-none min-w-0 w-full bg-white border border-transparent rounded-md py-2 px-4 text-sm text-gray-400 placeholder-gray-400 focus:outline-none sm:max-w-xs"
              placeholder="Enter your email"
            />
            <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                type="submit"
                className="w-full bg-white border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-sm font-medium text-emerald-400 hover:bg-white focus:outline-none"
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="mt-8 border-t border-white pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-sm text-white md:mt-0 md:order-1">
