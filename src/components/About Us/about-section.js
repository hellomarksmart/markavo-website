      ...
      <div className="max-w-default mx-auto px-4 sm:px-6 lg:px-8 py-0 px-4 lg:pt-16">
        <div className="space-y-12 xl:grid xl:grid-cols-3 xl:gap-8 xl:space-y-0">
          <div className="space-y-5 sm:space-y-4">
            <h2 className="text-header2 font-extrabold tracking-tight sm:text-header2sm">
              {heading}
            </h2>
            <p className="text-normalmd2 sm:text-normalmd text-gray-500">{description}</p>
          </div>
                      ...
                      <div className="w-full md:w-twoThirds w-full sm:col-span-2">
                        <div className="space-y-4 mt-0">
                          <div className="leading-6 font-medium space-y-1">
                            <h3 className="mb-1 text-header3sm sm:text-header3">
                              {item?.name.text}
                            </h3>
                            <p className="text-emerald-600 text-normalsm2 sm:text-normalsm pb-3">
                              {item?.position.text}
                            </p>
                          </div>
                          <div>
                            <p className="text-gray-500 text-normalmd2 sm:text-normalmd sm:-mt-[1rem]">
