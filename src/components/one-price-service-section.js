      ...
      <div className="pt-12 sm:pt-16 lg:pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-[30px] sm:text-[36px] lg:text-[48px] font-extrabold text-gray-900">
              {heading}
            </h2>
            <p className="mt-4 text-xl text-gray-600 md:text-[20px]">
              {description}
            </p>
          </div>
        </div>
                  ...
                  <ul className="mt-8 space-y-5 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-5 ml-0">
                    {card_features?.map((item, i) => (
                      <li key={i} className="flex items-start lg:col-span-1">
                        ...
                        <p className="ml-3 text-[14px] text-gray-700">
                          {item?.feature.text}
                        </p>
                      </li>
                    ))}
