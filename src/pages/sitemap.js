...
const Sitemap = () => {
  const list = [
    ...
    { title: '0008 - 404 ES', href: '/es/about-us' },
    ...
    { title: '0013 - All Services Application', href: '/all-services-disputes' },
    { title: '0014 - All Services Application ES', href: '/es/all-services-disputes' },
